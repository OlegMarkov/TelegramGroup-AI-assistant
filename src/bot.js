...
function registerCommands(instance) {
  ['start', 'onboarding', 'tips', 'help', 'summary', 'find', 'ask', 'filter', 'channel', 'subscribe', 'status', 'feedback', 'digest', 'stats', 'admin', 'broadcast', 'moderation', 'privacy', 'language'].forEach((name) => {
